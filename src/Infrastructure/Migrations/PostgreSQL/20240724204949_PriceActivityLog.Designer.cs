...
namespace Infrastructure.Migrations.PostgreSQL
{
    ...
    [Migration("20240724204949_PriceActivityLog")]
    partial class PriceActivityLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.PriceRule.PriceRuleTriggerLog", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_price_rule_trigger_log");

                    b.HasIndex("PriceRuleId")
                        .HasDatabaseName("ix_price_rule_trigger_log_price_rule_id");

                    b.ToTable("price_rule_trigger_log", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.PriceRule.PriceRuleTriggerLog", b =>
                {
                    b.HasOne("Domain.Models.PriceRule.PriceRule", "PriceRule")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_price_rule_trigger_log_price_rules_price_rule_id");

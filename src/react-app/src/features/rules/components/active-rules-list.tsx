...
export const ActiveRulesList = () => {
    ...
    return (
        <div>
            ...
            <h2 className="text-xl font-bold mb-4 flex gap-x-2">Active Rules<Puzzle /></h2>
                                        ...
                                        <div>
                                            ...
                                            <h3 className="text-lg font-medium">{rule.name}</h3>
                                                {rule.lastTriggeredAt && (
                                                    <p className='text-muted-foreground text-xs'>Last triggered: {formatDistanceToNow(rule.lastTriggeredAt,{addSuffix:true})}</p>
                                                )}
                                            </div>
